import {FETCH_PRODUCTS , FILTER_PRODUCTS_BY_SIZE , ORDER_PRODUCTS_BY_BRICE} from './types'
...
export const sortProducts = (filteredProducts , sort) => (dispatch) => {
    ...
    if(sort === "latest"){
        ...
        sortedProducts = sortedProducts.sort((a,b) => (a.id > b.id ? 1 : -1))
